...
//search by enter key on keyboard area
...
var timer
const createSlider = () => {
  // check slider image length area
  if (sliders.length < 2) {
...
// change slider index area
const changeItem = index => {
  changeSlide(slideIndex += index);
}

// change slide item area
